"""PResNet backbone (from RT-DETRv2, variant d).
...
class PResNet(nn.Module):
    def __init__(
        ...
        if pretrained:
            if isinstance(pretrained, str) and "http" in pretrained:
                url = pretrained
            else:
                url = f"https://github.com/lyuwenyu/storage/releases/download/v0.1/ResNet{depth}_vd_pretrained_from_paddle.pth"
