...
ONNX_PATH = ROOT / "runs/gatev_base/gatev_exported.onnx"
ONNX_DATA_PATH = ROOT / "runs/gatev_base/gatev_exported.onnx.data"
PTH_PATH = ROOT / "runs/gatev_base/gatev_edge_detect_final.pth"
CONFIG_PATH = ROOT / "configs/gatev_base.yaml"
...
class VisualizerGUI:
    def __init__(self, root: tk.Tk):
        ...
        # State Variables
        self.cfg = GatEVConfig.from_yaml(CONFIG_PATH)
