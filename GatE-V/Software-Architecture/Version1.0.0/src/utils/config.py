...
class ModelConfig:
    ...
    use_vfl: bool = True               # Varifocal Loss (VFL)
    use_clip_ensemble: bool = True     # Multi-prompt CLIP ensembling
...
class TrainingConfig:
    ...
    lr_T0: int = 15                    # CosineWarmRestarts T_0
    lr_T_mult: int = 1                 # CosineWarmRestarts T_mult
    ...
    use_task_freq_weighting: bool = True  # Inverse-sqrt task frequency weighting
