...
// inputs with no timing checks
  ...
  always @ (trig_attr) begin
    ...
    if ((attr_test == 1'b1) ||
        (SIM_DEVICE_REG != "ULTRASCALE" && (RX_REFCLK_FREQUENCY_REG < 300.0 || RX_REFCLK_FREQUENCY_REG > 2667.0))) begin
    ...
    if ((attr_test == 1'b1) ||
        (SIM_DEVICE_REG == "ULTRASCALE" && (RX_REFCLK_FREQUENCY_REG < 200.0 || RX_REFCLK_FREQUENCY_REG > 2400.0))) begin
    ...
    if ((attr_test == 1'b1) ||
        (SIM_DEVICE_REG != "ULTRASCALE" && (TX_REFCLK_FREQUENCY_REG < 300.0 || TX_REFCLK_FREQUENCY_REG > 2667.0))) begin
    ...
    if ((attr_test == 1'b1) ||
        (SIM_DEVICE_REG == "ULTRASCALE" && (TX_REFCLK_FREQUENCY_REG < 200.0 || TX_REFCLK_FREQUENCY_REG > 2400.0))) begin
