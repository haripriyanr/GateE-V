...
HD_PWD='/run/media/user/DATA/DVcon/GatE-V/Hardware-Architecture/Evaluation_DVcon/submission/DVCon_2026/VIVADO_PROJECT/DVCon_PJT_SYN_2026_05_08_26-23_53_31/DVCon_PJT_SYN_2026.runs/synth_1'
cd "$HD_PWD"
