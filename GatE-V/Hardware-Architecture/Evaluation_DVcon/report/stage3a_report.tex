...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{figures/gatev_architecture_diagram.jpg}
...
Clock & n/a & \textbf{50~MHz integrated SoC (100~MHz standalone target)} \\
Peak Throughput & 25.6 GOPS & \textbf{51.2 GOPS @ 50 MHz} \\
Feature Map Levels & P3, P4, P5 & \textbf{P2, P3, P4, P5 (FGPA + AFF)} \\
Slice LUT Usage (SoC total) & 1.20\% & \textbf{43.21\%} \\
GatE-V Accelerator LUT Usage & 1.20\% & \textbf{2.63\%} \\
DSP48E1 Usage (accelerator) & 256 (30.4\%) & \textbf{544 / 840 (64.76\%)} \\
DSP48E1 Usage (SoC total) & n/a & \textbf{594 / 840 (70.71\%)} \\
BRAM (BRAM18) Usage & 4 BRAMs & \textbf{122 / 890 (13.70\%)} \\
Simulation Tool & Vivado XSim & \textbf{QuestaSim 2019.2} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{figures/questa_real_simulation_waveform.png}
\caption{QuestaSim 2019.2 Real VCD Simulation Waveform illustrating AS1061 SoC boot sequence, AXI4 bus transactions, and accelerator execution over $20\,\mu\text{s}$.}
\label{fig:waveform}
\end{figure}
