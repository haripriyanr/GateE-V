...
package gatev_pkg;
    ...
    // ── Bus Widths ─────────────────────────────────────────────────────────
    parameter int ADDR_WIDTH   = 32;    // AXI4-Lite (fixed 32-bit)
    parameter int AXI_ADDR_W   = 64;    // AXI4 Full address width
    parameter int AXI_ID_W     = 12;    // AXI4 Full ID width
    parameter int AXI_DATA_W   = 64;    // AXI4 Full data width

    // ── AXI-Lite Register Address Map ───────────────────────────────────────
    parameter logic [31:0] CTRL_REG_ADDR       = 32'h0000_0000;
    parameter logic [31:0] STATUS_REG_ADDR     = 32'h0000_0004;
    parameter logic [31:0] TASK_ID_REG_ADDR    = 32'h0000_0008;
    parameter logic [31:0] MODE_REG_ADDR       = 32'h0000_000C;
    parameter logic [31:0] IMG_BASE_ADDR_REG   = 32'h0000_0010;
    parameter logic [31:0] WT_BASE_ADDR_REG    = 32'h0000_0014;
    parameter logic [31:0] OUT_BASE_ADDR_REG   = 32'h0000_0018;
    parameter logic [31:0] TILES_NUM_REG_ADDR  = 32'h0000_001C;
    parameter logic [31:0] DMA_SRC_ADDR_REG    = 32'h0000_0020;
    parameter logic [31:0] DMA_DST_ADDR_REG    = 32'h0000_0024;
    parameter logic [31:0] DMA_LEN_REG         = 32'h0000_0028;
    parameter logic [31:0] DMA_CTRL_REG        = 32'h0000_002C;
    parameter logic [31:0] BURST_TYPE_REG      = 32'h0000_0030;
    parameter logic [31:0] BURST_LEN_REG       = 32'h0000_0034;
    parameter logic [31:0] PERF_CYCLE_LOW      = 32'h0000_0040;
    parameter logic [31:0] PERF_CYCLE_HIGH     = 32'h0000_0044;
    parameter logic [31:0] PERF_READ_BYTES     = 32'h0000_0048;
    parameter logic [31:0] PERF_WRITE_BYTES    = 32'h0000_004C;
    parameter logic [31:0] PERF_MAC_CYCLES     = 32'h0000_0050;
    parameter logic [31:0] PERF_STALL_CYCLES   = 32'h0000_0054;

    // ── Register Field Offsets ─────────────────────────────────────────────
    parameter int CTRL_START_BIT     = 0;
    parameter int STATUS_DONE_BIT    = 0;
    parameter int DMA_CTRL_START_BIT = 0;
    parameter int DMA_CTRL_DIR_BIT   = 1;
    ...
    // ── MAC Engine ─────────────────────────────────────────────────────────
    parameter int MAC_ROWS    = 32;
    parameter int MAC_COLS    = 16;
    parameter int PIPE_STAGES = 3;

    // ── Backbone / Tile Scheduler ──────────────────────────────────────────
    parameter int MAX_IMG_WIDTH  = 800;
    parameter int MAX_IMG_HEIGHT = 800;
    parameter int LINE_BUF_DEPTH = 1024;
    parameter int MAX_CHANNELS   = 2048;
    parameter int MAC_TILE_OUT_CH = 8;
    parameter int MAC_TILE_IN_CH  = 8;
